// Agentic HIL — embedded widget for the blog article.
...
// only controls *when* that already-true content is revealed. Trimmed from
// the standalone kiosk version (./kiosk/script.js): no full-screen cover,
// no unattended Demo Mode loop — "Run Simulation" is the only trigger,
// single-shot, meant to be read inline in an article rather than take over
// the whole screen.
...
(() => {
  ...
  // ---------------------------------------------------------------------
  // Init — widget starts fully populated, no animation, until "Run
